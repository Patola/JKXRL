...
typedef struct {
	...
	void (*VR_SetSpatialConsoleState)( qboolean active, float scaleX, float scaleY, float opacity );
	qboolean (*VR_GetSpatialConsolePointer)( int hand, float *x, float *y, float *distance );
